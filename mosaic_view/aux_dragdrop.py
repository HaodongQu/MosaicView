...
class FourDragDropImageLabel(QtWidgets.QFrame):
    ...
    def __init__(self):
        ...
        self.app_main_topleft   = DragDropImageLabel(show_filename=True, show_pushbuttons=True, is_main=True, text_default="Base image\n(required)")
        self.app_topright       = DragDropImageLabel(show_filename=True, show_pushbuttons=True, text_default="Right image\nleft-right mode")
        self.app_bottomleft     = DragDropImageLabel(show_filename=True, show_pushbuttons=True, text_default="Bottom image\ntop-bottom mode")
        self.app_bottomright    = DragDropImageLabel(show_filename=True, show_pushbuttons=True, text_default="Extra image\nquad mode")
